  ...
  module ConnectionAdapters
    class SchemaCacheTest < ActiveRecord::TestCase
      ...
      def test_yaml_dump_and_load
        ...
        # Create an empty cache again.
        cache = SchemaCache.new @connection

        # Load it from the file.
        cache.load_from(tempfile.path)
      ...
      def test_yaml_loads_5_1_dump
        ...
        assert_empty cache.instance_variable_get(:@columns)
        assert_empty cache.instance_variable_get(:@columns_hash)
        assert_empty cache.instance_variable_get(:@data_sources)
        assert_empty cache.instance_variable_get(:@primary_keys)

        cache.load_from(schema_dump_path)
